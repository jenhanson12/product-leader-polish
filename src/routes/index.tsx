            ...
            <div className="lg:col-span-8">
              ...
              <div className="text-muted-foreground text-lg leading-relaxed space-y-5">
                ...
                <p>
                  ...
                  building toward a goal, getting the team to win is a recurring theme for me. I'm
                  also an AI tinkerer and I believe the best way to bring AI into a business is to
                  start by having fun with it, sparking curiosity before optimizing for outcomes.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24 border-t border-border/60">
        <div className="max-w-3xl mx-auto px-6 sm:px-8 text-center">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-10">
            I work with no more than a couple clients at a time so I have real impact. If you're
